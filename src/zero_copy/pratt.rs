...
/// use chumsky::zero_copy::pratt::{pratt, InfixOperator, InfixPrecedence, Associativity};
///
...
impl<'a, I, E, Expr, AtomParser, OpParser, Op> Parser<'a, I, Expr, E>
...
where
    ...
    Op: InfixOperator<Expr>,
{
    fn go<M: Mode>(&self, inp: &mut InputRef<'a, '_, I, E>) -> PResult<M, Expr, E::Error>
    where
        Self: Sized,
    {
