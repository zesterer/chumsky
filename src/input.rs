...
impl<'a, 'parse, I: Input<'a>, E: ParserExtra<'a, I>> InputRef<'a, 'parse, I, E> {
    ...
    // TODO: Rename this and next_token_ref to next/next_ref?
    #[inline(always)]
    pub fn next_token_maybe(&mut self) -> Option<MaybeRef<'a, I::Token>> {
        // SAFETY: offset was generated by previous call to `Input::next`
    ...
    #[inline(always)]
    pub fn next_token_ref(&mut self) -> Option<&'a I::Token>
    where
        I: BorrowInput<'a>,
    {
        self.next_ref().1
