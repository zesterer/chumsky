...
impl<'src> ExactSizeInput<'src> for &'src ByteStr {
    #[inline(always)]
...
impl<'src> StrInput<'src> for &'src ByteStr {
    #[doc(hidden)]
...
impl<'src> SliceInput<'src> for &'src ByteStr {
    type Slice = &'src ByteStr;
...
impl<'src> ValueInput<'src> for &'src ByteStr {
    #[inline(always)]
